...
import com.pdd.mapper.EmployeeMapper;
import com.pdd.mapper.MailSendLogMapper;
import com.pdd.pojo.*;
...
//            String msgId = UUID.randomUUID().toString();
            ...
            mailSendLog.setRouteKey(MailConstant.MAIL_ROUTING_KEY_NAME);
            mailSendLog.setExchange(MailConstant.MAIL_EXCHANGE_NAME);
            mailSendLog.setCount(0);
            mailSendLog.setTryTime(LocalDateTime.now().plusMinutes(MailConstant.MSG_TIMEOUT));
