	...
	<div>
		<div>
			...
			<el-button
				...
				type="primary"
				round
                @click="addPositon">添加</el-button>
		</div>
		<div class="posManaMain">
			<el-table :data="positions" size="medium" stripe border @selection-change="handleSelectionChange" 
                        style="width: 70%">
...
export default {
    ...
    methods:{
        deleteMany(){
                this.$confirm('是否删除['+this.multipleSelection.length+']条职位', '提示', {
